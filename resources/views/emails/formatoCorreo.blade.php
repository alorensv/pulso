...
<head>
	...
	<title>Entreganos tu propiedad</title>
</head>
<body>
                                                            ...
                                                            <tr>
                                                                <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                    <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="header-row-td" width="378" style="text-align:center;font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
                                                                                    <a href="https://pulsopropiedades.cl">
                                                                                        <img src="http://pulsopropiedades.cl/public/images/logo-min.png" class="mx-auto d-block img-fluid" style="display:block; margin:0 auto;">
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    ...
                                                                    <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                                        <b style="color: #777777;">Nuevo correo desde item contacto de la página web Pulso Propiedades</b>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                                ...
                                                                <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                    <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: left;">
                                                                        <table class='table table-striped table-bordered display nowrap'>
                                                                            <?php if(isset($contacto['clave'])){
                                                                                echo "<tr>";
                                                                                    echo "<th>Propiedad (Palabra clave):</th>";
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;" valign="top">
                                                                                    <a href="https://pulsopropiedades.cl" style="color: #428bca; text-decoration: none; background-color: transparent;">
                                                                                        Pulso Propiedades &copy; 2021
                                                                                    </a>
                                                                                    <br>{{-- 
